...
<form id="" action="{{ route('smo_profile_user_action') }}" method="POST">
    {{ csrf_field() }}
    ...
    <table class="table table-bordered puzz-table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="form-inline">
                        <input name="password" type="password" class="form-control" placeholder="@lang('smo/members.form.password_reset_placeholder')">
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-inline">
                        <input name="password_confirmation" type="password" class="form-control" placeholder="@lang('smo/members.form.password_reset_placeholder')">
                    </div>
                </td>
            </tr>
        </tbody>
