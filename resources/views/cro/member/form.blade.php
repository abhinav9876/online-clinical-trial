            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-inline">
                            @if (!empty($user))
                                <input name="password" type="password" class="form-control" placeholder="@lang('cro/members.form.password_reset_placeholder')" value="">
                            @else
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-inline">
                            @if (!empty($user))
                                <input name="password_confirmation" type="password" class="form-control" placeholder="@lang('cro/members.form.password_reset_placeholder')" value="">
                            @else
