...
return [
    ...
    */
    ...
    'confirmed'            => ':attributeがconfirmation用の値と一致しません。',
    ...
    'email'                => ':attributeには正しい形式のmail addressを指定してください。',
    ...
    */
    ...
    'attributes' => [
        ...
        'address_sup' => 'Street address(続き)',
        'address_notes' => 'Street address(Remarks)',
        ...
        'drug' => '薬剤コード',
        'drug_type' => '薬剤種別',
        'notification_enabled' => ' Noticesetting',
        'notification_email' => ' Notice対象リスト',
        'maker_id' => 'メーカ ID',
        'category' => 'カテゴリ',
        'status' => 'Status',
        ...
        'participation_benefits' => '参加メリット',
        'exam_day_notes' => 'Examination date注意事項',
        'facility_name' => '施設 name',
        'start_recruitment_at' => 'post公開開始日',
        'end_recruitment_at' => 'post公開終了日',
        'required_no_scr' => 'SCR人数',
        'crc_name' => 'CRCResponsible name',
        'crc_email' => 'CRC担当者mail address',
        'exam_schedule_items' => '実施スケジュール',
        'reward_items' => '負担軽減費/協力費',
        'facility_zip_code' => '郵便番号',
        'facility_address' => 'Street address',
        'facility_address_sup' => 'Street address(続き)',
        'facility_address_notes' => 'Street address(Remarks)',

        // online_screeners

        // online_screener_questions
        'online_screener_id' => 'OSCR ID',
        'text' => 'A question文',
        'answer_type' => 'A question種別',
        'dropdown_values' => 'dropdown項目',
        'checkbox_values' => 'checkbox項目',
        'matrix_question_values' => 'matrix question value',

        // online_screener_answers
        'subject_id' => ' Application ID',
        'online_screener_question_id' => 'OSCRA question ID',
        'dropdown_selected' => 'dropdown選択値',
        'checkbox_selected' => 'checkbox選択値',
        'freetext' => 'Free WordReply値',
        'matrix_selected' => 'matrix selected value',

        // For View
        'admin_email' => 'mail address',
    ],
